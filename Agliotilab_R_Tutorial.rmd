...
Lists are higher level structures, a list can contain several different other data structures inside it, it can contain multiple dataframes, multiple vectors
